 ...
 * 
*/
void test_shell_sort(vector<int>& nums)
{
 ...
 * 逻辑2：nums[i]如果小于num[i-1]，则swap，循环继续
...
*/
void test_insertion_sort(vector<int>& nums)
{
   if(nums.size() < 2) {
       return;
   }
...
void test_insertion_sort1(vector<int>& nums)
{
   if(nums.size() < 2) {
       return;
   }
...
TEST(test_sort_inseartion_sort, testcase0)
{
    // {1,2,3,4,5,6,7,9};
    vector<int> nums = {7,6,9,3,1,5,2,4,10};
    test_insertion_sort(nums);
